          ...
          <div className="flex gap-x-5 w-full bg-gray-100 p-5 pt-10">
              ...
              <div className="mt-10 px-10">       
                      <div className="flex gap-x-20 p-4 pt-6">
                        ...
                        <div className="flex flex-col">
                          <div>
                            <button>
                              <i class="bi bi-trash3-fill text-gray-500 hover:text-red-600" onClick={showDeleteModel}></i>
                            </button>
                          </div>
            ...
            <div className="w-1/3 bg-white h-fit">
              ...
              <div className="flex justify-between mt-5 px-6 w-full">
                ...
                <div className="flex flex-col gap-y-3">
                  <div className="flex justify-end">₹{(price*quantity).toLocaleString()}</div>
                  <div className="flex justify-end">- ₹{((price-offer)*quantity).toLocaleString()}</div>
              ...
              <div className="mt-5 flex justify-between font-semibold text-lg px-5 text-primary mb-5">
                <div>You will save ₹{((price-offer)*quantity).toLocaleString()} on this order</div>
              </div>
            </div>
          </div>
        </section>
